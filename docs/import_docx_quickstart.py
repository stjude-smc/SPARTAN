#!/usr/bin/env python3
"""
Import SPARTAN Quick Start Guide.docx into a single quickstart.rst.
...
DOCX_NAME = "SPARTAN Quick Start Guide.docx"
OUTPUT_RST = "quickstart.rst"
PAGE_TITLE = "SPARTAN Quick Start Guide"
