function varargout = autotrace2(varargin)
% AUTOTRACE2  Trace processing and filtering
%
...
% Last Modified by GUIDE v2.5 04-Oct-2008 11:37:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @autotrace2_OpeningFcn, ...
    'gui_OutputFcn',  @autotrace2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before autotrace2 is made visible.
function autotrace2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to autotrace2 (see VARARGIN)
...
handles.BINS=40; % histogram bins size
...
% Choose default command line output for autotrace2
handles.output=hObject;

% Update handles structure
guidata(hObject,handles);

% END FUNCTION autotrace2_OpeningFcn



% --- Outputs from this function are returned to the command line.
function varargout = autotrace2_OutputFcn(hObject, eventdata, handles)
...
% END FUNCTION autotrace2_OutputFcn
...
if datadir~=0,
    set(handles.editFilename,'String',datadir);
end
...
% --- Executes on selection change in dlbStats.
function dlbStats_Callback(hObject, eventdata, handles)
% hObject    handle to dlbStats (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
