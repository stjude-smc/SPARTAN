...
load('simulated_tag_less_precise_4_dt_0.15.mat')
...
while true
    ...
    chain = chainer_main(chain,chain_length,[],true,false);
    ...
    export_chain(chain, 1 , ['tag_mean_sim_',num2str(tag),'_',num2str(tag_case),'_',num2str(length(chain.i))]);
    plot_escrate;
