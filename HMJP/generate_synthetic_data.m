function [observation,units,ground] = generate_synthetic_data(tag,show_demo)
...
prec           = 10; %(1/nm^2);
obs_wind_left  = (0.1 :dt :5-(0.08))'; %same size as obs(COLUMN)
...
mu_D            =  [50;1000];%photons/sec  mean state(1 2 3) = (1 2 5)(units of space)
mu_A            =  [10;500];%photons/sec  mean state(1 2 3) = (1 2 5)(units of space)
...
save(['simulated_tag_less_precise_realistic_' num2str(tag),'.mat'],'ground','observation','units','-v7.3')
