...
save(['simulated_tag_less_precise_' num2str(tag),'_dt_',num2str(dt_1),'.mat'],'ground','observation','units','-v7.3')
...
hold off
export_fig data_set_1_gillespie_traj -pdf
%% Observations 
    fig = figure(2);
...
export_fig data_set_1_analyzed_obs -pdf
...
title('Simulated Observations')
box on
export_fig data_set_2_gillespie_traj_obs -pdf
...
%     plot_stairs(tn_bnd,sn);
  ...
  export_fig data_set_2_analyzed_obs -pdf
...
export_fig data_set_3_gillespie_traj_obs -pdf
...
hold off
export_fig data_set_4_gillespie_traj -pdf
...
export_fig data_set_4_gillespie_traj_obs -pdf
...
%     plot_stairs(tn_bnd,sn);
  ...
  export_fig data_set_4_analyzed_obs -pdf
